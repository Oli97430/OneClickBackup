...
_T["en"] = {
    ...
    "part.merge_prompt": "Enter the number of the adjacent partition to merge with:",
    "part.merge_confirm": "Merge partitions {p1} and {p2}? All data on partition {p2} will be lost!",
    "part.merge_queued": "Merge operation queued.",
    ...
    "bak.restore_confirm": "Restore backup '{name}'? Existing data will be overwritten.",
    "bak.restore_done": "Backup restored successfully.",
    "bak.verify_pass": "Backup integrity verified — all checksums match.",
    "bak.verify_fail": "Backup verification FAILED — data may be corrupted.",
    "bak.verify_running": "Verifying backup integrity...",
    "bak.delete_confirm": "Permanently delete backup '{name}'? This cannot be undone.",
    "bak.delete_done": "Backup deleted.",
    ...
    "adv.wipe_done": "Disk wipe completed successfully.",
...
_T["fr"] = {
    ...
    "part.merge_prompt": "Numéro de la partition adjacente à fusionner :",
    "part.merge_confirm": "Fusionner les partitions {p1} et {p2} ? Toutes les données de {p2} seront perdues !",
    "part.merge_queued": "Opération de fusion en file d'attente.",
    ...
    "bak.restore_confirm": "Restaurer la sauvegarde '{name}' ? Les données existantes seront écrasées.",
    "bak.restore_done": "Sauvegarde restaurée avec succès.",
    "bak.verify_pass": "Intégrité vérifiée — toutes les sommes de contrôle correspondent.",
    "bak.verify_fail": "La vérification a ÉCHOUÉ — les données pourraient être corrompues.",
    "bak.verify_running": "Vérification de l'intégrité...",
    "bak.delete_confirm": "Supprimer définitivement la sauvegarde '{name}' ? Cette action est irréversible.",
    "bak.delete_done": "Sauvegarde supprimée.",
    ...
    "adv.wipe_done": "L'effacement du disque est terminé.",
